...
public class MxParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("mx");
  ...
  { 
    MxParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MxParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MxParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MxParseControllerGenerated.class);
    }
  ...
  { 
    return MxParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
